context("SHLITR_demographics_ode")
...
test <- SHLITR_demographics_ode(1, inits, parameters)


test_that("SHLITR_deographics_ode can correctly return rates of change over one timestep", {
  expect_known_output(test, file = "../../tests/test-files/SHLITR_demographics_ode/test-01.rds")
})
