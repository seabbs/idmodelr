...
Of particular interest are integrations of other model families (i.e. discrete, stochastic) and models implemented in other languages (i.e C) that integrate with R.
