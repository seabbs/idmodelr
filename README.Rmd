...
parameters <- data.frame(
  beta = 3, ##Transmission rate = contact rate * transmission probability
  tau = 0.5, ## Rate recovery = 1 / duration of infection
...
This package was developed in a docker container based on the [tidyverse](https://hub.docker.com/r/rocker/tidyverse/) docker image. To run the docker image run:
