# Getting help with idmodelr

Thanks for using idmodelr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/seabbs/idmodelr/issues) to make sure the 
